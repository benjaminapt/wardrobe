...
export const OptimizedImage = forwardRef(function OptimizedImage({
  ...
  if (!normalizedSource || normalizedSource.startsWith("data:") || normalizedSource.startsWith("blob:") || normalizedSource.startsWith("/api/") || normalizedSource.startsWith("/wardrobe/")) {
